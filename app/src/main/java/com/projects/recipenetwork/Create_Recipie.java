...
public class Create_Recipie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_create__recipie);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(Create_Recipie.this,Home.class);
                startActivity(a);
            }
        });
        dishes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(Create_Recipie.this,Dishes.class);
                startActivity(b);
            }
        });
        ...
        drinks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent c = new Intent(Create_Recipie.this,Drinks.class);
                startActivity(c);
            }
        });
        ...
        crtrecipie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent d = new Intent(Create_Recipie.this, Create_Recipie.class);
                startActivity(d);
            }
        });
        ...
        myRecipie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent e = new Intent(Create_Recipie.this, MyRecipie.class);
                startActivity(e);
            }
        });
